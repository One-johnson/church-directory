...
export const COUNTRIES: Country[] = [
  ...
  { code: "CG", name: "Congo", flag: "fi fi-cg" },
  { code: "CD", name: "Congo (DRC)", flag: "fi fi-cd" },
  ...
  { code: "ST", name: "Sao Tome and Principe", flag: "fi fi-st" },
  ...
  { code: "VN", name: "Vietnam", flag: "fi fi-vn" },
...
export function getCountryFlagClass(code: string): string{
